...
| 1207/1208 | `MSG_HANDLE_FRIEND_REQ` / `MSG_HANDLE_FRIEND_RSP` | `action=accept/reject` 处理申请 |
| 1301/1302 | `MSG_TEXT_CHAT_REQ` / `MSG_TEXT_CHAT_RSP` | 文本消息持久化请求/响应 |
| 1305/1306 | `MSG_CREATE_PRIVATE_CHAT_REQ` / `MSG_CREATE_PRIVATE_CHAT_RSP` | 创建私聊会话 |
...
| 1507/1508 | `MSG_RESOURCE_CHUNK_UPLOAD_REQ` / `MSG_RESOURCE_CHUNK_UPLOAD_RSP` | 上传分片 |
| 1509/1510 | `MSG_RESOURCE_UPLOAD_PROGRESS_REQ` / `MSG_RESOURCE_UPLOAD_PROGRESS_RSP` | 查询上传进度 |
| 1511/1512 | `MSG_RESOURCE_DOWN_INFO_REQ` / `MSG_RESOURCE_DOWN_INFO_RSP` | 查询下载信息 |
| 1513/1514 | `MSG_RESOURCE_CHUNK_DOWN_REQ` / `MSG_RESOURCE_CHUNK_DOWN_RSP` | 下载分片 |
...
`1205`、`1209`、`1303`、`1407`、`1408`、`1505` 和 `1702` 均为空号，没有兼容语义。
