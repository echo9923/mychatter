...
//头像通道（1601-1604）保持旧 seq+MD5 协议；资源消息通道（1507/1509/1511/1513）
...
public:
    ...
    //窗口发送下一批资源分片（1507）：从 MsgInfo 当前确认偏移续读。
    ...
    //启动资源下载：1511 查元数据 -> 1513 逐片下载（自动/手动触发统一入口）
...
signals:
    void sig_close();
     ...
     //资源上传收全（1508 resource_status=1），OutboxDispatcher 据此 confirmResourceSent
     ...
     //1509/1510 上传进度查询回包（OutboxDispatcher 重启恢复续传用）
