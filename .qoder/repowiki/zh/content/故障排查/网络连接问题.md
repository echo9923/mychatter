...
- 全局常量与协议ID：定义消息ID、错误码、最大长度、拥塞窗口等
...
Server->>Server : "校验msg_id/msg_len"
...
### 协议与错误码
- 客户端与服务器共用消息ID枚举，确保请求/响应匹配
- 错误码统一在JSON中携带error字段，便于解析与提示
- 服务器侧对非法msg_id/msg_len直接清理会话，防止资源泄露
...
- 关键常量
  ...
  - 服务器头部总长度：HEAD_TOTAL_LEN=4，头部ID长度：HEAD_ID_LEN=2，头部数据长度：HEAD_DATA_LEN=2
