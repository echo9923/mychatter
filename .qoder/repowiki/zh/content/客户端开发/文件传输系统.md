...
- global.h：定义 ReqId 消息ID、TransferState/Type、MsgInfo、DownloadInfo、MAX_FILE_LEN、MAX_CWND_SIZE 等关键常量与结构体。
...
- 接收缓冲与粘包解析状态（_buffer, _b_recv_pending, _message_id, _message_len）。
